    ...
    <section id="about" className="py-32 px-8 md:px-16 bg-[#050507]">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <a href="/Vishnu_Shaji.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-mono text-gray-400 hover:text-[var(--color-neon-cyan)] transition-colors gap-2">
